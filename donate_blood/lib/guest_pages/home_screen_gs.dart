...
import 'package:donate_blood/guest_pages/home_page_gs.dart';
import 'package:donate_blood/guest_pages/request_page_gs.dart';
import 'package:donate_blood/guest_pages/user_page_gs.dart';
import 'package:flutter/material.dart';

class HomeScreenGS extends StatefulWidget {
  const HomeScreenGS({super.key});

  @override
  State<HomeScreenGS> createState() => _HomeScreenGSState();
}

class _HomeScreenGSState extends State<HomeScreenGS> {
  ...
  _getPages() {
    switch (selectedPage) {
      case 0:
        return const HomePageGS(); // Display the 'Home' page
      case 1:
        return RequestPageGS(); // Display the 'D/R' page
      case 2:
        return const UserPageGS(); // Display the 'Users' page
    }
  }
}
